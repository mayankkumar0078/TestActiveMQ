...
public class ChatApp1 implements javax.jms.MessageListener{
	...
	public ChatApp1(String connectionFactoryName,String topicName,String username) throws NamingException, JMSException {
	...
	public static void main(String[] args) {
		...
		try {
			ChatApp1 app=new ChatApp1(args[0],args[1],args[2]);
